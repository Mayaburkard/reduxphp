<?php require_once("db_const.php");  $connection = new mysqli(HOST, USER, PASS, NAME); $connection->set_charset("utf8");  ?> <!doctype html>
...
<html> 
    ...
    <body>
        ...
        <h1>Chuck Norris Facts</h1><?php 
         ...
         <?php 
		 $jokedata = $connection->query("SELECT * FROM jokes ORDER BY id DESC"); while($joke = $jokedata->fetch_assoc()){
